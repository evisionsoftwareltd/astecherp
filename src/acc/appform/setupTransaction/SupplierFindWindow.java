...
public class SupplierFindWindow extends Window
{
	...
	public SupplierFindWindow(SessionBean sessionBean,TextField txtReceiptSupplierId,String frmName)
	{
		this.txtReceiptSupplierId = txtReceiptSupplierId;
		this.sessionBean=sessionBean;
		this.setCaption("FIND SUPPLIER INFO :: "+this.sessionBean.getCompany());
		this.center();
		this.setWidth("590px");
	...
	private void finButtonEvent()
	{
		try
		{
			...
			String sql = " select supplierId,supplierName,address from tbSupplierInfo  where supplierId like"
					+ " '"+findString+"' or supplierName like '"+findString+"' or address like '"+findString+"' order by supplierName ";
	...
	private void compInit()
	{
		...
		txtSearch.setDescription("Find Suppiler Information using supplier id or supplier name or address.");
		...
		table.setColumnWidth("Supplier Name",200);
