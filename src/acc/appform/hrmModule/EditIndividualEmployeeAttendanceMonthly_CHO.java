...
public class EditIndividualEmployeeAttendanceMonthly_CHO extends Window {
		...
		public EditIndividualEmployeeAttendanceMonthly_CHO(SessionBean sessionBean)
		{
		...
		private void cmbEmployeeAddData(String type)
		{
			...
			try
			{
				...
				if(type=="Employee ID")
				{
					query="select distinct vEmployeeID,employeeCode from tbEmployeeMainAttendance where " +
							"MONTH(dDate)='"+dbMonthFormat.format(dMonth.getValue())+"' " +
							"and Year(dDate)='"+dbYearFormat.format(dMonth.getValue())+"' " +
							"and vDepartmentID = '"+cmbDepartment.getValue()+"' " +
							"and vSectionID = '"+cmbSection.getValue()+"' order by employeeCode";
					lblEmployee.setValue("Employee ID : ");
				}
				else if(type=="Proximity ID")
				{
					query="select distinct vEmployeeID,vProximityID,employeeCode from tbEmployeeMainAttendance where " +
							"MONTH(dDate)='"+dbMonthFormat.format(dMonth.getValue())+"' " +
							"and Year(dDate)='"+dbYearFormat.format(dMonth.getValue())+"' " +
							"and vDepartmentID = '"+cmbDepartment.getValue()+"' " +
							"and vSectionID = '"+cmbSection.getValue()+"' order by employeeCode";
				...
				{
					query="select distinct vEmployeeID,vEmployeeName,employeeCode from tbEmployeeMainAttendance where " +
							"MONTH(dDate)='"+dbMonthFormat.format(dMonth.getValue())+"' " +
							"and Year(dDate)='"+dbYearFormat.format(dMonth.getValue())+"' " +
							"and vDepartmentID = '"+cmbDepartment.getValue()+"' " +
							"and vSectionID = '"+cmbSection.getValue()+"' order by employeeCode";
		...
		private void addTableData()
		{
			...
			try
			{
				String query = "select dTxtDate,vTxtDay,Convert(date,dInTime) InDate,DATEPART(HH,dInTime) InHour," +
						...
						"TxtStatus from funMonthlyEmployeeAttendanceCHO('"+dbDateFormat.format(dMonth.getValue())+"'," +
