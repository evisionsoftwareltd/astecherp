...
public class IncrementProcessFind extends Window
{
	...
	public IncrementProcessFind(SessionBean sessionBean,Label IncrementDate,Label SectionID,Label IncrementType,Label EmployeeName)
	{
	...
	private void SectionValueAdd()
	{
		...
		try
		{
			String query = "select distinct vSectionID, vSectionName from tbSalaryIncrement where vSectionName !='CHO'";
