...
public class MonthlyAdjustmentNDeductionFind extends Window 
{
	...
	public MonthlyAdjustmentNDeductionFind(SessionBean sessionBean, TextRead strMonth, TextRead strDepartmentID, TextRead strSectionID)
	{		
