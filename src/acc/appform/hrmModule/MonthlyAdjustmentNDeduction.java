...
public class MonthlyAdjustmentNDeduction extends Window 
{
	...
	public MonthlyAdjustmentNDeduction(SessionBean sessionBean) 
	{
		this.sessionBean=sessionBean;
		this.setResizable(false);
		this.setCaption("MONTHLY ADJUSTMENT AND DEDUCTION :: " + sessionBean.getCompany());
	...
	{
		Window win = new MonthlyAdjustmentNDeductionFind(sessionBean, txtMonth, txtDepartmentID, txtSectionID);
