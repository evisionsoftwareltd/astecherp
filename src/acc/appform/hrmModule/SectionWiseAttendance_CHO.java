...
public class SectionWiseAttendance_CHO extends Window {
		...
		public SectionWiseAttendance_CHO(SessionBean sessionBean)
		{
			this.sessionbean=sessionBean;
			this.setCaption("SECTION WISE ATTENDANCE MANUALLY CHO:: "+sessionbean.getCompany());
			buildMainLayout();
