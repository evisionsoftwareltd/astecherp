...
public class LoanApplicationForm extends Window
{
	...
	public LoanApplicationForm(SessionBean sessionBean)
	{
	...
	private void employeeSetData(String employeeId)
	{
		...
		try
		{
			...
			String active = " select * from tbLoanApplication where vAutoEmployeeId = '"+employeeId+"' and iLoanStatus = '0' and iSanctionStatus='0' " ;
