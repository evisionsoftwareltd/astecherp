...
public class SectionFindWindow extends Window
{
	...
	private void tableDataAdding()
	{
		...
		try
		{
			String query ="Select ISNULL(vDepartmentID,'') vDepartmentID,ISNULL(vDepartmentName,'') vDepartmentName,"
					+ "vSectionID,SectionName,Address from tbSectionInfo where SectionName!= 'CHO' order by vDepartmentName,SectionName desc";
