...
public class TourApplicationFormCHO extends Window {
		...
		public TourApplicationFormCHO(SessionBean sessionBean)
		{
			this.sessionBean=sessionBean;
			this.setCaption("TOUR APPLICATION FORM CHO::"+sessionBean.getCompany());
