...
public class TabExperience extends Form
{
	...
	{
		for(int i=0;i<tblTxtPost.size();i++){
			allComp.add(tblTxtPost.get(i));
			allComp.add(tblTxtCompanyName.get(i));
			allComp.add(tblDateFrom.get(i));
			allComp.add(tblDateTo.get(i));
			allComp.add(tblTxtMajorTask.get(i));	
		}
	...
	public void tableRowAdd(final int ar)
	{
		...
		tblDateFrom.get(ar).setDateFormat("dd-MM-yyyy");
		...
		tblDateTo.get(ar).setDateFormat("dd-MM-yyyy");
	...
	public void init(){
		...
		table.setColumnWidth("Major Responsibility",280);
