...
public class LeaveTypeFindWindo extends Window
{
	...
	private void tableDataAdding()
	{
		...
		try
		{
			String selectQuery = "select iLeaveTypeId, vLeaveTypeName from tbLeaveType order by AutoID " ;
