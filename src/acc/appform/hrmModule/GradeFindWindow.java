...
public class GradeFindWindow extends Window {
		...
		public GradeFindWindow(SessionBean sessionBean,TextField txtReceiptSupplierId,String frmName)
		{
			this.txtReceiptSupplierId = txtReceiptSupplierId;
			this.sessionBean=sessionBean;
			this.frmNam=frmName;
			this.setCaption("GRADE FIND WINDOW :: "+sessionBean.getCompany());
			this.center();
			this.setWidth("420px");
		...
		private void tableDataDepartment(String department)
		{
			...
			{
				showNotification("tableDataGrade", ex.toString(), Notification.TYPE_ERROR_MESSAGE);
			}
			finally
			{
				session.close();
