...
public class LcChargeHeadEntry extends Window
{
	...
	public LcChargeHeadEntry(SessionBean sessionBean)
	{
		this.sessionBean = sessionBean;
		this.setResizable(false);
		this.setCaption("CHARGE INFO :: "+this.sessionBean.getCompany());
	...
	{
		Window win = new LcChargeHeadEntryFind(sessionBean, txtCategoryID);
	...
	private void findInitialise(String txtCategoryId) 
	{
		...
		try 
		{
			String sql = "Select headId,headName,isActive from tbLcHeadInfo Where headId = '"+txtCategoryId+"'";
