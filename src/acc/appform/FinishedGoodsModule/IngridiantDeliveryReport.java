...
public class IngridiantDeliveryReport extends Window{
	...
	public IngridiantDeliveryReport(SessionBean sessionBean,String s){

		this.sessionBean=sessionBean;
		this.setCaption("INGRIDIANT DELIVERY REPORT::"+sessionBean.getCompany());
	...
	{	
		...
		try{
			...
			if(!list.isEmpty())
			{
				Window win = new ReportViewerNew(hm,"report/account/finishedGoods/RptIngrideanDeliveryReport.jasper",
	...
	private AbsoluteLayout buildMainLayout() {
		...
		mainLayout.addComponent(lblPartyName,"top:40.0px;left:10px;");
