...
public class FGOpeningFindWindow extends Window {
	...
	public FGOpeningFindWindow(SessionBean sessionBean,TextField txtItemId){
		...
		this.setCaption("FG OPENING FIND :: "+sessionBean.getCompany());
	...
	private void semiFgSubLoad() {
		...
		String sql="select fgCode,fgName from tbFgOpening order by fgName";
	...
	private void tableDataLoad(String semiFgSub){
		...
		String sql="select fgCode,fgName from tbFgOpening where fgCode like '"+semiFgSub+"'";
