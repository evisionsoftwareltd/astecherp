...
public class RptItemInformation3rd0 extends Window {
	...
	private void reportShow()
	{
		try{
			...
			query= "SElect (select vSourceName from tbSourceInfo where iSourceID like tb3rdPartylabelInformation.vSource) vSource,vPartyId,vPartyName,vLabelCode,vLabelName,vUnit,mMax,mRefill,mMin,vlabelNamesource from tb3rdPartylabelInformation where vSource like '"+sourceName+"' and vPartyId like '"+partyName+"' and vLabelCode like '"+labelName+"'"
