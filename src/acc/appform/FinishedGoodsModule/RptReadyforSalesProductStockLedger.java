...
public class RptReadyforSalesProductStockLedger extends Window{
	...
	public RptReadyforSalesProductStockLedger(SessionBean sessionBean,String s){

		this.sessionBean=sessionBean;
		this.setCaption("READY FOR SALES STOCK DETAILS::"+sessionBean.getCompany());
	...
	private void setEventAction() {
		...
		previewButton.addListener(new ClickListener() {
			...
			public void buttonClick(ClickEvent event) 
			{
				...
				{
					if(true/*cmbItem.getValue()!=null || chkAll.booleanValue()*/)
					{
						reportView();
					}
					else
	...
	{	
		...
		try{
			...
			query= 	"select *  from funReadyforSalesStockLedger('"+datef.format(formDate.getValue())+"', '"+datef.format(toDate.getValue())+"' , '"+PartyId+"')" ;
			hm.put("sql", query);

			List list=session.createSQLQuery(query).list();
			if(!list.isEmpty())
			{
				Window win = new ReportViewerNew(hm,"report/account/finishedGoods/ReadyforSalesStockLedger.jasper",
	...
	private AbsoluteLayout buildMainLayout() 
	{
		...
		mainLayout.addComponent(lblPartyName,"top:42.0px;left:10px;");
		...
		mainLayout.addComponent( cmbPartyName, "top:40.0px;left:85px;");
		...
		mainLayout.addComponent( chkallPartyName, "top:40.0px;left:395.0px;");
		...
		mainLayout.addComponent( chkAll, "top:45.0px;left:476.0px;");
