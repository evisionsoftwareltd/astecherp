...
public class RptFinishedGoodsOpeningEditLog extends Window {
	...
	boolean type=false;
	public RptFinishedGoodsOpeningEditLog(SessionBean sessionBean,String str) {
		this.sessionBean = sessionBean;

		setContent(buildMainLayout());
		this.setResizable(false);
		this.setCaption("FINISHED GOODS OPENING EDIT LOG :: "+ sessionBean.getCompany());
	...
	private void reportShow()
	{
		...
		try{
			...
			query= " select * from tbUdFgOpening where fgCode like '"+fgName+"' and udSl != '1' order by fgName,autoId";
			...
			if(!lst.isEmpty())
			{
				...
				Window win = new ReportViewer(hm,"report/account/finishedGoods/RptFinishedGoodsOpeningEditLog.jasper",
	...
	public void addFgNameData()
	{
		...
		try{
			...
			String query =" select Distinct fgCode,fgName from tbUdFgOpening order by fgName ";
