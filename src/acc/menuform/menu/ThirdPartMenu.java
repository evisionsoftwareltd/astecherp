...
public class ThirdPartMenu {
	...
	public ThirdPartMenu(Object thirdpartyModule, Tree tree, SessionBean sessionBean,Component component) 
	{	
		this.tree = tree;
		...
		{
			thirdpartysetup = addCaptionedItem("Third Party R/M SETUP", thirdpartyModule);
			addThirPartySetUp(thirdpartysetup);
		}

		if(isValidMenu("productionTransaction"))
		{
			thirdpartyTransaction = addCaptionedItem("Third Party R/M Transaction", thirdpartyModule);
			addThirPartyTransaction(thirdpartyTransaction);
			
		}
		if(isValidMenu("productionReports"))
		{
			thirpartyReport = addCaptionedItem("Third Party R/M Reports", thirdpartyModule);
