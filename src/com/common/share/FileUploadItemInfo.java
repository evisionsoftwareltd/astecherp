...
public class FileUploadItemInfo extends VerticalLayout {

    public Label status = new Label("Please select a image file to upload");
    ...
    public FileUploadItemInfo(String fname) {
