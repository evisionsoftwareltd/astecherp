...
public class RptPartyInfo extends Window
{
	...
	public RptPartyInfo(SessionBean sessionBean)
	{
		this.sessionBean = sessionBean;
		this.setCaption("PARTY INFORMATION :: "+this.sessionBean.getCompany());
	...
	private void previewBtnAction()
	{
		...
		try
		{
			...
			queryAll = "select * from tbPartyInfo where DivisionId like '"+Division+"' and AreaId like '"+Area+"' and isActive='1' order by DivisionId,areaName,partyName";
			...
			Window win = new ReportViewer(hm,"report/account/SetupTransaction/rptPartyInfo.jasper",
