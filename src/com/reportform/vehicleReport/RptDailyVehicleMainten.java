...
public class RptDailyVehicleMainten extends Window 
{
	...
	public RptDailyVehicleMainten(SessionBean sessionBean)
	{
		this.sessionBean = sessionBean;
		this.setCaption("DAILY VEHICLE MAINTENANCE :: "+sessionBean.getCompany());
	...
	private void generateReport()
	{
		...
		try
		{
			...
			hm.put("findDate", dateFormat.format(dEntryDate.getValue()));
//			hm.put("logo", sessionBean.getCompanyLogo());

			query=" select c.regNumber,b.expenseHead,b.quantity,b.unit,b.rate,b.amount,b.billNo," +
				  " b.supplier,a.maintenType,b.endMeterRead,b.runningMilage,b.costPerMile," +
				  " b.lastRepDate,b.totalAmount,b.lastSupplier,b.remarks from tbVehicleMainten as a" +
				  " inner join tbVehicleMaintenTable as b on a.maintenId=b.maintenId left join tbVehicleInfo as c" +
				  " on a.vehicleRegistrationNo=c.vehicleId where a.vehicleRegistrationNo like '"+vehicleRegNo+"' and" +
				  " a.maintenType like '"+vehicleMainten+"' and a.entryDate='"+dateFormat.format(dEntryDate.getValue())+"' ";
			...
			if(queryValueCheck(query))
			{
				...
				Window win = new ReportViewer(hm,"report/account/vehicleModule/rptDailyVehicleMainten.jasper",
	...
	private AbsoluteLayout buildMainlayout()
	{
		...
		mainLayout.addComponent(dEntryDate, "top:67px; left:135px;");
		...
		mainLayout.addComponent(cButton, "top:165px; left:120px; ");
