...
public class RptOTNFridayEnableCHO extends Window {
		...
		public RptOTNFridayEnableCHO(SessionBean sessionBean) 
		{
			this.sessionBean=sessionBean;
			this.setCaption("OT & FRIDAY ENABLE CHO:: "+sessionBean.getCompany());
		...
		private void reportShow(Object sectionName)
		{
			...
			try
			{
				String query = "select ei.employeeCode,ei.vProximityId,ei.vEmployeeId,ei.vEmployeeName,ei.vDepartmentID,sinf.vDepartmentName," +
						...
						"ei.vSectionId=sinf.vSectionId where ei.vSectionId like '"+sectionName+"' and (ei.otStatus=1 or ei.FridayStatus=1) and " +
						"ei.iStatus=1 and ISNULL(vProximityID,'')!='' and (ei.vSectionId like 'SEC-41' or ei.vSectionId like 'SEC-42') and ei.iStatus like '"+status+"'   order by sinf.vDepartmentName,sinf.SectionName,ei.employeeCode,din.designationSerial,ei.dJoiningDate";
