...
public class RptEmployeeInformationOfficial_CHO extends Window 
{
	...
	public RptEmployeeInformationOfficial_CHO(SessionBean sessionBean)
	{
		this.sessionBean=sessionBean;
		this.setCaption("EMPLOYEE LIST_CHO(OFFICIAL) :: "+sessionBean.getCompany());
