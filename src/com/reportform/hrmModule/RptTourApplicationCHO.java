...
public class RptTourApplicationCHO extends Window {
		...
		public RptTourApplicationCHO(SessionBean sessionBean)
		{
			this.sessionBean=sessionBean;
			this.setCaption("TOUR APPLICATION CHO:: "+sessionBean.getCompany());
		...
		private void EmployeeDataAdd()
		{
			...
			try
			{
				...
				{
					query = "select vEmployeeID,vProximityID from tbTourApplication where " +
							"dTourFrom ='"+dFormat.format(dTourFrom.getValue())+"' and " +
							"dTourTo='"+dFormat.format(dTourTo.getValue())+"' and vApprovedFlag ='1' " +
							"order by vEmployeeCode";
