...
public class RptAllIncrementList extends Window {
	...
	public RptAllIncrementList(SessionBean sessionBean) 
	{
		this.sessionBean=sessionBean;
		this.setCaption("INCREMET LIST :: "+sessionBean.getCompany());
	...
	private void reportShow()
	{
		...
		{	
			...
			query = "select tsl.vEmployeeId,tsl.employeeCode,tsl.vEmployeeName,tsl.vDesignationName," +
					...
					"DateDiff(DD,ein.dInterviewDate,tsl.dDate)%365/30 dMonth,vIncrementType,mBasic ,mGross,mNewBasic,mNewGross," +
					"vIncrementPercentage,mIncrementAmount from tbSalaryIncrement tsl inner join tbEmployeeInfo ein on " +
					"ein.vEmployeeId=tsl.vEmployeeId where tsl.vDepartmentId like '"+Department+"' and tsl.vDepartmentId not like 'DEPT10' " +
