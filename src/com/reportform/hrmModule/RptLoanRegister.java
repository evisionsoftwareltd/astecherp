...
public class RptLoanRegister extends Window 
{
	...
	public RptLoanRegister(SessionBean sessionBean) 
	{
		this.sessionBean=sessionBean;
		this.setCaption("LOAN REGISTER :: "+sessionBean.getCompany());
		this.setWidth("500px");
		...
		try
		{
			if(radioLoanStatus.getValue().toString().equals("Active"))
			{
				query = " select ei.employeeCode,ei.vEmployeeName,dept.vDepartmentName,si.SectionName,di.designationName,ei.dJoiningDate," +
						...
						" and la.vDepartmentID like '"+(cmbDepartmentName.getValue()!=null?cmbDepartmentName.getValue().toString():"%")+"' and la.vDepartmentID not like 'DEPT10' " +
