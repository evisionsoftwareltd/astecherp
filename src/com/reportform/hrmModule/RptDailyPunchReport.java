...
public class RptDailyPunchReport extends Window {
	...
	public RptDailyPunchReport(SessionBean sessionBean)
	{
		this.sessionBean=sessionBean;
		this.setCaption("DAILY PUNCH REPORT :: "+sessionBean.getCompany());
	...
	public void cmbDepartmentAddData()
	{
		...
		try
		{
			String query="select distinct vDepartmentId,vDepartmentName from tbEmployeeMainAttendance " +
					"where dDate=('"+dFormat.format(dDate.getValue())+"') and vDepartmentId not like 'DEPT10' order by vDepartmentName";
