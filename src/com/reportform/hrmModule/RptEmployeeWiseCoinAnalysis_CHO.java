...
public class RptEmployeeWiseCoinAnalysis_CHO extends Window
{
	...
	public RptEmployeeWiseCoinAnalysis_CHO(SessionBean sessionBean)
	{
		this.sessionBean=sessionBean;
		this.setCaption("EMPLOYEE WISE COIN ANALYSIS(CHO) :: "+sessionBean.getCompany());
	...
	private void reportShow(String Department,String Section,String Employee)
	{
		...
		try
		{
			String query="select * from dbo.funEmpCoinAnalysis('DEPT10','SEC-41','"+Employee+"','"+monthformat.format(dMonth.getValue())+"','"+yearformat.format(dMonth.getValue())+"') order by vDepartmentName,SectionName,vEmployeeCode";
