...
public class RptIndividualIncrementHistory extends Window {
	...
	public RptIndividualIncrementHistory(SessionBean sessionBean) 
	{
		this.sessionBean=sessionBean;
		this.setCaption("INDIVIDUAL NCREMET HISTORY :: "+sessionBean.getCompany());
