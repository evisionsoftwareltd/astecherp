...
public class RptLeaveRegisterCHO extends Window {
		...
		public RptLeaveRegisterCHO(SessionBean sessionBean) 
		{
			this.sessionBean=sessionBean;
			this.setCaption("LEAVE REGISTER CHO:: "+sessionBean.getCompany());
			this.setWidth("500px");
...
/*			chkDepartmentAll.addListener(new ValueChangeListener()
		...
		private void reportpreview()
		{
			...
			try
			{
				String query=" select * from funLeaveRegisterCHO('"+cmbYear.getValue().toString()+"'," +
