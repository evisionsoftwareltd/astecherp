...
public class RptIndividualLoanStatementCHO extends Window {
		...
		public RptIndividualLoanStatementCHO(SessionBean sessionBean) 
		{
			this.sessionBean=sessionBean;
			this.setCaption("INDIVIDUAL LOAN STATEMENT CHO :: "+sessionBean.getCompany());
