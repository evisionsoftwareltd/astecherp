...
public class RptMonthlyAttendance extends Window 
{
	...
	private void reportShow(String sectionName,String employeeName)
	{
		...
		try
		{	
			String query = "select * from funMonthlyEmployeeAttendance('"+dFormat.format(dMonth.getValue())+"','"+employeeName+"','"+cmbDepartment.getValue()+"','"+sectionName+"') order by vEmployeeCode,dTxtDate";
