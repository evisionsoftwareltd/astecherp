...
public class RptEditMonthlySalaryCHO extends Window {
		...
		public RptEditMonthlySalaryCHO(SessionBean sessionBean)
		{
			this.sessionBean=sessionBean;
			this.setCaption("EDIT MONTHLY SALARY CHO:: "+sessionBean.getCompany());
