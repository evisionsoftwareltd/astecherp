...
public class RptLabelStockAsOnDate extends Window{
	...
	public RptLabelStockAsOnDate(SessionBean sessionBean,String s){

		this.sessionBean=sessionBean;
		this.setCaption("LABEL STOCK AS ON DATE::"+sessionBean.getCompany());
