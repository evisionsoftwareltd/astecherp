...
public class RptLabelStockDateBetween extends Window{
	...
	public RptLabelStockDateBetween(SessionBean sessionBean,String s){

		this.sessionBean=sessionBean;
		this.setCaption("LABEL STOCK DATE BETWEEN::"+sessionBean.getCompany());
