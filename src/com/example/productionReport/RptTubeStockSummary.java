...
public class RptTubeStockSummary extends Window{
	...
	public RptTubeStockSummary(SessionBean sessionBean,String s){

		this.sessionBean=sessionBean;
		this.setCaption("TUBE STOCK SUMMARY::"+sessionBean.getCompany());
	...
	private AbsoluteLayout buildMainLayout() {
		...
		mainLayout.addComponent(chklayout, "top:112.0px; left:140.0px");
