...
public class RptTubeIssue extends Window{
	...
	public RptTubeIssue(SessionBean sessionBean,String s){

		this.sessionBean=sessionBean;
		this.setCaption("TUBE PRODUCTION ISSUE::"+sessionBean.getCompany());
	...
	private void challandataload() {
		...
		try{
			...
			Session session=SessionFactoryUtil.getInstance().getCurrentSession();
			tx=session.beginTransaction();
			query="select distinct  0,ChallanNo from tbTubeIssueInfo where IssueTo like '"+cmbTo.getValue()+"'  ";
	...
	private AbsoluteLayout buildMainLayout() {
		...
		mainLayout.addComponent(chklayout, "top:110.0px; left:130.0px");
