...
public class RptTubeSectionWiseOpeningStock extends Window{
	...
	public RptTubeSectionWiseOpeningStock(SessionBean sessionBean,String s){

		this.sessionBean=sessionBean;
		this.setCaption("TUBE OPENING STOCK::"+sessionBean.getCompany());
...
*/
			query=  " select a.productid,b.vRawItemName,b.vUnitName,a.qty,a.productionType,c.productTypeName, a.openignYear, b.vCategoryType  from tbsectionOpenignStock a" +
					" inner join" +
					" tbRawItemInfo b" +
					...
					" tbProductionType c" +
					" on" +
					" c.productTypeId=a.productionType" +
					" where a.sectionId like '"+cmbStep.getValue()+"' and  YEAR(a.openignYear)  like '"+datef.format(dYear.getValue())+"' and a.productionType like '"+cmbType.getValue()+"'";
			...
			if(!list.isEmpty()){
				Window win = new ReportViewerNew(hm,"report/production/rptSectionWiseProductionOpening.jasper",
	...
	private AbsoluteLayout buildMainLayout() {
		...
		dYear.setWidth("107px");
		dYear.setHeight("-1px");
		dYear.setInvalidAllowed(false);
		mainLayout.addComponent( dYear, "top:67.0px;left:140.0px;");
