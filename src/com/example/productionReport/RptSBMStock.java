...
public class RptSBMStock extends Window{
	...
	public RptSBMStock(SessionBean sessionBean,String s){

		this.sessionBean=sessionBean;
		this.setCaption("SBM STOCK ::"+sessionBean.getCompany());
	...
	private void cmbSemiFgLoad() {
		...
		try
		{
			...
			String sql="select Distinct semiFgSubId,semiFgSubName from tbSemiFgSubInformation ";
	...
	{	
		...
		try{
			...
			query= "select * from funSBMStock('"+semiFg+"','"+datef.format(formDate.getValue())+"') ";
			hm.put("sql", query);
			List list=session.createSQLQuery(query).list();
			if(!list.isEmpty()){
				Window win = new ReportViewerNew(hm,"report/production/rptSBMStock.jasper",
	...
	private AbsoluteLayout buildMainLayout() {
		...
		mainLayout.addComponent(chklayout, "top:105.0px; left:140.0px");
