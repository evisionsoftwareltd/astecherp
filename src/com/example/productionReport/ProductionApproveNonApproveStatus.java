...
public class ProductionApproveNonApproveStatus extends Window{
	...
	public ProductionApproveNonApproveStatus(SessionBean sessionBean,String s){

		this.sessionBean=sessionBean;
		this.setCaption("PRODUCTION APPROVE NON APPROVE STATUS::"+sessionBean.getCompany());
	...
	{	
		...
		try{
			...
			query="select date,Convert(varchar,DATENAME(WEEKDAY,date)) dayName,blowMoulding,injectionMoulding,injectionBlowMoulding,stretchBlowMoulding,labeling,printing,capFolding "
					+ ",dop,screenPrinting,htl,manualPrinting,lacqure,assemble,shrink from funcProductionDataEntryApproveNonApprove('"+datef.format(formDate.getValue())+"','"+datef.format(toDate.getValue())+"','"+productionType+"')";
			
			//query="select date,DATENAME(WEEKDAY,date)dayName,blowMoulding,injectionMoulding,injectionBlowMoulding," +
					//"stretchBlowMoulding,labeling,capFolding,dop,screenPrinting,htl,manualPrinting,lacqure,assemble " +
					//"from funcProductionDataEntryApprove('"+datef.format(formDate.getValue())+"','"+datef.format(toDate.getValue())+"','"+productionType+"')";
			...
			if(!list.isEmpty()){
				Window win = new ReportViewerNew(hm,"report/production/RptApproveEntryStatus.jasper",
	...
	//	setHeight("270px");
		...
		mainLayout.addComponent(chkAll, "top:16.0px;left:370.0px;");
	...
	//	mainLayout.addComponent( cmbFgName, "top:41.0px;left:140.0px;");
		...
		mainLayout.addComponent( formDate, "top:40.0px;left:140.0px;");
		...
		mainLayout.addComponent( toDate, "top:66.0px;left:140.0px;");
		...
		mainLayout.addComponent(chklayout, "top:91.0px; left:140.0px");
		...
		mainLayout.addComponent(lblLine, "top:125.0px;left:15.0px;");

		previewButton.setWidth("100px");
		previewButton.setHeight("28px");
		previewButton.setIcon(new ThemeResource("../icons/print.png"));
		mainLayout.addComponent(previewButton,"top:150.opx; left:135.0px");

		exitButton.setWidth("70px");
		exitButton.setHeight("28px");
		exitButton.setIcon(new ThemeResource("../icons/exit1.png"));
		mainLayout.addComponent(exitButton,"top:150.opx; left:220.0px");
