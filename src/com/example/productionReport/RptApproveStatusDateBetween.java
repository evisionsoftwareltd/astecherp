...
public class RptApproveStatusDateBetween extends Window{
	...
	public RptApproveStatusDateBetween(SessionBean sessionBean,String s){

		this.sessionBean=sessionBean;
		this.setCaption("PRODUCTION APPROVE STATUS::"+sessionBean.getCompany());
	...
	{	
		...
		try{
			...
			query="select date,Convert(varchar,DATENAME(WEEKDAY,date)) dayName,blowMoulding,injectionMoulding,injectionBlowMoulding,stretchBlowMoulding,labeling,printing,capFolding "
					+ ",dop,screenPrinting,htl,manualPrinting,lacqure,assemble,shrink from funcProductionDataEntryApprove('"+datef.format(formDate.getValue())+"','"+datef.format(toDate.getValue())+"','"+productionType+"')";
