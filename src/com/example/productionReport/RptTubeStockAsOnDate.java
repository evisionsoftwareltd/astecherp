...
public class RptTubeStockAsOnDate extends Window{
	...
	public RptTubeStockAsOnDate(SessionBean sessionBean,String s){

		this.sessionBean=sessionBean;
		this.setCaption("TUBE STOCK AS ON DATE::"+sessionBean.getCompany());
	...
	private AbsoluteLayout buildMainLayout() {
		...
		mainLayout.addComponent(lblLine, "top:135.0px;left:25.0px;");

		previewButton.setWidth("80px");
		previewButton.setHeight("28px");
		previewButton.setIcon(new ThemeResource("../icons/print.png"));
		mainLayout.addComponent(previewButton,"top:163.opx; left:130.0px");

		exitButton.setWidth("70px");
		exitButton.setHeight("28px");
		exitButton.setIcon(new ThemeResource("../icons/exit1.png"));
		mainLayout.addComponent(exitButton,"top:163.opx; left:220.0px");
