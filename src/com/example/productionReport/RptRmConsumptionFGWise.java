...
public class RptRmConsumptionFGWise extends Window{
	...
	public RptRmConsumptionFGWise(SessionBean sessionBean,String s){
	...
	{	
		...
		try{
			...
			if(!list.isEmpty()){
				Window win = new ReportViewerNew(hm,"report/production/rptFgWithConsumption.jasper",
