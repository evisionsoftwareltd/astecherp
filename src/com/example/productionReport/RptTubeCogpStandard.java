...
public class RptTubeCogpStandard extends Window{
	...
	public RptTubeCogpStandard(SessionBean sessionBean,String s){
	...
	{	
		...
		try{
			...
			if(!list.isEmpty()){
				Window win = new ReportViewerNew(hm,"report/production/rptCogpStandardAstech.jasper",
