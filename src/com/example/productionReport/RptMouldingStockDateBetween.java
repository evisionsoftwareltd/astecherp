...
public class RptMouldingStockDateBetween extends Window{
	...
	public RptMouldingStockDateBetween(SessionBean sessionBean,String s){

		this.sessionBean=sessionBean;
		this.setCaption("TUBE STOCK DATE BETWEEN::"+sessionBean.getCompany());
	...
	private AbsoluteLayout buildMainLayout() {
		...
		mainLayout.addComponent(lblToDate, "top:93.0px;left:40.0px;");
