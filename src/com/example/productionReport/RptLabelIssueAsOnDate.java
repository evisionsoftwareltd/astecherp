...
public class RptLabelIssueAsOnDate extends Window{
	...
	public RptLabelIssueAsOnDate(SessionBean sessionBean,String s){

		this.sessionBean=sessionBean;
		this.setCaption("LABEL PRODUCTION ISSUE REGISTER AS ON DATE ::"+sessionBean.getCompany());
	...
	{	
		...
		try{
			...
			query = " select  a.jobDate,a.jobNo,a.ChallanNo, b.fgId ,a.issueQty,a.itemCode ," +
					...
					" where CONVERT(Date,a.jobDate,105) <='"+datef.format(fromDate.getValue())+"'" +
			...
			List list=session.createSQLQuery(query).list();
			if(!list.isEmpty()){
				Window win = new ReportViewerNew(hm,"report/production/rptLabelIssueRegisterAsOn.jasper",
