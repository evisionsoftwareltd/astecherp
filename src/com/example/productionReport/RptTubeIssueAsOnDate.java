...
public class RptTubeIssueAsOnDate extends Window{
	...
	public RptTubeIssueAsOnDate(SessionBean sessionBean,String s){
	...
	{	
		...
		try{
			...
			List list=session.createSQLQuery(query).list();
			if(!list.isEmpty()){
				Window win = new ReportViewerNew(hm,"report/production/rptTubeIssueRegisterAsOn.jasper",
	...
	private AbsoluteLayout buildMainLayout() {
		...
		mainLayout.addComponent(chklayout, "top:104.0px; left:130.0px");
		...
		mainLayout.addComponent(previewButton,"top:166.opx; left:125.0px");

		exitButton.setWidth("70px");
		exitButton.setHeight("28px");
		exitButton.setIcon(new ThemeResource("../icons/exit1.png"));
		mainLayout.addComponent(exitButton,"top:166.opx; left:220.0px");
