...
public class FindLoanIssueRcv extends Window{
	...
	public FindLoanIssueRcv(SessionBean sessionBean,TextField txtReceiptId,String frmName)
	{
	...
	public void supplierNameData()
	{
		...
		try {
			...
			List<?> list = session.createSQLQuery("select IssuedTo,a.supplierName from tbRawIssueInfo "
					+ "inner join tbSupplierInfo a on IssuedTo= a.supplierId where IssueType like '%Loan%' order by a.supplierName ").list();
