...
public class RptThirdpartyStockLedger extends Window {
	...
	boolean type=true;
	public RptThirdpartyStockLedger(SessionBean sessionBean,String str) {
		this.sessionBean = sessionBean;
		setContent(buildMainLayout());
		this.setResizable(false);
		this.setCaption("STOCK LEDGER ::  "+ sessionBean.getCompany());
		cmbItemName.focus();
	...
	private void reportShow()
	{
		...
		try{
			...
			hm.put("toDate",new SimpleDateFormat("dd-MM-yyyy").format(toDate.getValue()));
				...
				query= "select (select vUnitName from tbThirdPartyItemInfo "
						+ "where vCode=funThirdPartyRMStockLedger.productId)vUnitName,* from "
						+ " funThirdPartyRMStockLedger("
			...
			if(!lst.isEmpty())
			{
				Window win = new ReportViewer(hm,"report/production/Thirdparty/rptStockLedger.jasper",
	...
	public void addItemName()
	{
		...
		try{
			...
			String query = "select Distinct vCode, vItemName from tbThirdPartyItemInfo";
