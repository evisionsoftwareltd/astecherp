...
public class RawItemCategory extends Window 
{
	...
	private void insertData()
	{
		...
		try
		{
			...
			String insertQuery = "Insert Into tbRawItemCategory (iCategoryCode,vCategoryName,Group_Id,vUserName,vUserIP,dtEntryTime,vCategoryType)" +
					" values ('"+categoryRead.getValue()+"','"+txtCategoryname.getValue()+"','"+categoryRead.getValue()+"', " +
					" '"+sessionBean.getUserName()+"','"+sessionBean.getUserIp()+"',CURRENT_TIMESTAMP,'"+type.getValue()+"')";
	...
	public void updateData() 
	{
		...
		try
		{
			...
			String updateQuery = "Update tbRawItemCategory set " +
					...
					" dtEntryTime= CURRENT_TIMESTAMP, vCategoryType = '"+strcattype+"'  where iCategoryCode = '"+categoryRead.getValue()+"'";
