...
public class ProductionStepProcess extends Window 
{
		...
		cmbGroupName.addListener(new ValueChangeListener() {
			...
			public void valueChange(ValueChangeEvent event) {
				...
				if(cmbGroupName.getValue()!=null){
					trSubGroupId.setValue("STP-"+subGroupIdWork());
	...
	private String subGroupIdWork(){
		...
		try 
		{
			...
			String sql="select isnull(max(cast(SUBSTRING(stepId,5,LEN(stepId))as int)),0)+1 as cat from tbProductionStep where productionTypeId like  '"+cmbGroupName.getValue()+"'";
	...
	private AbsoluteLayout buildMainLayout() 
	{
		...
		mainLayout.addComponent(trSubGroupId, "top:34.0px;left:150.0px;");
		...
		mainLayout.addComponent(txtSubGroupName, "top:63.0px;left:150.0px;");
		//lblGrouopName
		...
		mainLayout.addComponent(cmbGroupName, "top:92.0px;left:150.0px;");
		...
		mainLayout.addComponent(nbGroup,"top:92.0px;left:435.0px;");
