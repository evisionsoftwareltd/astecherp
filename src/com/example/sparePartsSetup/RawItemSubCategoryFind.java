...
public class RawItemSubCategoryFind extends Window
{
	...
	public RawItemSubCategoryFind(SessionBean sessionBean,TextField txtReceiptSupplierId)
	{
		this.txtReceiptSupplierId = txtReceiptSupplierId;
		this.sessionBean=sessionBean;
		this.setCaption("FIND RAW SUB CATEGORY INFO :: "+sessionBean.getCompany());
		this.center();
		this.setWidth("470px");
...
//		tableDataAdding();
	...
	private void cmbCategoryData()
	{
		...
		try
		{
			...
			String query = "";
			query = "select a.iCategoryID, b.vCategoryName from tbRawItemSubCategory a" +
							" inner join" +
							" tbRawItemCategory b" +
							" on a.iCategoryID = b.iCategoryCode" +
	...
	private void tableDataAdding()
	{
		try{
			...
			String query ="Select iSubCategoryID,vSubCategoryName from tbRawItemSubCategory where iCategoryID like '"+cmbCategory.getValue().toString()+"'  order by vSubCategoryName";
