...
public class SpareItemSubCategory extends Window 
{
	...
	public SpareItemSubCategory(SessionBean sessionBean) 
	{
		this.sessionBean=sessionBean;
		this.setCaption("SPARE PARTS SUB CATEGORY :: " + sessionBean.getCompany());
	...
	public void setEventAction()
	{
		...
		txtSubcategoryName.addListener(new ValueChangeListener() 
		{
			public void valueChange(ValueChangeEvent event) 
			{
				...
				if(!txtSubcategoryName.getValue().toString().isEmpty())
				{
					List list = session.createSQLQuery("select * from tbRawItemSubCategory where vSubCategoryName like '"+txtSubcategoryName.getValue().toString().trim()+"'").list();
					
					if(list.isEmpty() )
					{
					  System.out.println("txtSubcategoryName");	
					}
					else
					{
						if(!isFind)
						{
							 showNotification("Warning! SubCategory Name Already Exists :" +txtSubcategoryName.getValue().toString());
	...
	{
		Window win = new SpareItemSubCategoryFind(sessionBean, txtSubCategoryID);
	...
	private void insertData()
	{
		...
		try
		{
			...
			String insertQuery = "Insert Into tbRawItemSubCategory (iSubCategoryID,vSubCategoryName,iCategoryID," +
					" Group_Id,SubGroup_Id,vUserName,vUserIP,dtEntryTime,vCategoryType,vflag) values" +
					...
					" '"+sessionBean.getUserIp()+"',CURRENT_TIMESTAMP,'"+cmbcategoryType.getValue()+"','New')";
