...
public class RptLowerLevelStockSP extends Window {
	...
	public  RptLowerLevelStockSP(SessionBean sessionBean,String str) {
		this.sessionBean = sessionBean;
		buildMainLayout();
		setContent(mainLayout);
		this.setResizable(false);
		this.setCaption("Re-Order LEVEL STOCK STATEMENT ::  "+ sessionBean.getCompany());
	...
	private void reportShow()
	{
		...
		try{
			...
			tx.commit();
             ...
             query="select * from   tbTmpLevelStatement where ReLevel >=StockQty order by SUBSTRING(groupid,2,LEN(groupid)),SUBSTRING(subgroupid,2,LEN(subgroupid)),SUBSTRING(subsubgroupid,2,LEN(subsubgroupid))  ";     
		...
		/*	Window win = new ReportViewer(hm,"report/rawProductInfoRpt.jasper",
			...
			Window win = new ReportViewer(hm,"report/raw/rptreorderqty.jasper",
					this.getWindow().getApplication().getContext().getBaseDirectory()+"".replace("\\","/")+"/VAADIN/rpttmp",
					this.getWindow().getApplication().getURL()+"VAADIN/rpttmp",false,
