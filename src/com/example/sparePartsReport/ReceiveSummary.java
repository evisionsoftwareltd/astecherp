...
public class ReceiveSummary extends Window {
	...
	public  ReceiveSummary(SessionBean sessionBean,String str) {
	...
	private void subcategorydataload()
	{
		...
		String query = "select SubGroup_Id, vSubCategoryName from tbRawItemSubCategory where   vCategoryType like '"+categoryType+"' and Group_Id like '"+Category+"' ";
	...
	private void productDataload()
	{
		...
		String query= " select vRawItemCode,vRawItemName  from tbRawItemInfo a inner join tbRawItemCategory b on a.vGroupId=b.Group_Id where  a.vCategoryType like '"+categorytype+"' and vGroupId like '"+strcategory+"' and vSubGroupId like '"+strsubcategory+"'  ";
		System.out.println(query);
