...
public class DeptWiseIssueSummarySP extends Window {
	...
	boolean type=false;
	public DeptWiseIssueSummarySP(SessionBean sessionBean,String str) {
		this.sessionBean = sessionBean;
		setContent(buildMainLayout());
		this.setResizable(false);
		this.setCaption("SECTION WISE ISSUE SUMMARY ::  "+ sessionBean.getCompany());
		cmbCategoryName.focus();
		Component ob[]={cmbCategoryName, cmbSectionName,cmbitem,fromDate,toDate,previewButton};
