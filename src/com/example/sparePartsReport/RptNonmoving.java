...
public class RptNonmoving extends Window 
{
	...
	public RptNonmoving(String str,SessionBean sessionBean) 
	{
		this.sessionBean = sessionBean;
		buildMainLayout();
		setContent(mainLayout);
		this.setResizable(false);
		this.setCaption("Non Moving Item Information::  "+ sessionBean.getCompany());
	...
	private AbsoluteLayout buildMainLayout() 
	{
		...
		mainLayout.addComponent(previewButton,"top:161.opx; left:170.0px");

		exitButton.setWidth("70px");
		exitButton.setHeight("28px");
		exitButton.setIcon(new ThemeResource("../icons/exit.png"));
		mainLayout.addComponent(exitButton,"top:161.opx; left:250.0px");
	...
	private void categoryData(String CategoryType)
	{
		...
		String query= "select iCategoryCode,vCategoryName from tbRawItemCategory "
				+"where vCategoryType not like 'Spare Parts' and vCategoryType like '"+CategoryType+"' "
	...
	private void reportShow()
	{
		...
		try{
			...
			session.createSQLQuery("exec PrcNonmoving '"+new SimpleDateFormat("yyyy/MM/dd").format(dAsOnDate.getValue()) +" "+"23:59:59" + "','"+categoryID+"'  ,'"+productID+"','"+categoryType+"' ").executeUpdate();
			tx.commit();
			...
			Window win = new ReportViewerNew(hm,"report/raw/rptNonMoveitem.jasper",
