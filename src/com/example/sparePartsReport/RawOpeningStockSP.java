...
public class RawOpeningStockSP extends Window 
{
	...
	public  RawOpeningStockSP(SessionBean sessionBean,String str) {
	...
	private AbsoluteLayout buildMainLayout() 
	{
		...
		mainLayout.addComponent(lblline, "top:196.0px;left:20.0px;");


		previewButton.setWidth("80px");
		previewButton.setHeight("28px");
		previewButton.setIcon(new ThemeResource("../icons/print.png"));
		mainLayout.addComponent(previewButton,"top:212.opx; left:170.0px");

		exitButton.setWidth("70px");
		exitButton.setHeight("28px");
		exitButton.setIcon(new ThemeResource("../icons/exit.png"));
		mainLayout.addComponent(exitButton,"top:212.opx; left:250.0px");
	...
	private void categoryType()
	{
		...
		String query = "select  distinct 0,vCategoryType from tbRawItemCategory Where vCategoryType  like '%Spare Parts%'";
...
/*
			...
			*/
			...
			query= " select * from tbRawProductOpening a "
					...
					+"where b.vRawItemCode like '"+productID+"'  and b.vGroupId like '"+categoryID+"' and b.vSubGroupId like '"+subcategoryID+"' and b.vsubsubCategoryId like '"+subsubcategory+"' and  DATEPART(YEAR,a.openingYear) like '"+dateFormat.format(dOpeningYear.getValue())+"' " ;
		...
		/*	Window win = new ReportViewer(hm,"report/rawProductInfoRpt.jasper",
			...
			Window win = new ReportViewer(hm,"report/rptOpeningStock.jasper",
					this.getWindow().getApplication().getContext().getBaseDirectory()+"".replace("\\","/")+"/VAADIN/rpttmp",
					this.getWindow().getApplication().getURL()+"VAADIN/rpttmp",false,
					this.getWindow().getApplication().getURL()+"VAADIN/applet",false);
