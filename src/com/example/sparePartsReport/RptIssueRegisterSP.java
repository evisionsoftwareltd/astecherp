...
public class RptIssueRegisterSP extends Window {
	...
	public  RptIssueRegisterSP(SessionBean sessionBean,String str) {
	...
	//ISNULL(Replace(CONVERT(char(10),Reqdate,103),'/','-'),'1900-01-01') ReqDate,
			String sql= 
					   ...
					   +"and c.vSubGroupId like '"+subcategoryID+"'  and a. vflag='New'   union all " 
					   ...
					   +"and c.vSubGroupId like '"+subcategoryID+"'  and a. vflag='New') "
