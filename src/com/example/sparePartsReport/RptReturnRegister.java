...
public class RptReturnRegister extends Window {
	...
	public  RptReturnRegister(SessionBean sessionBean,String str) {
		this.sessionBean = sessionBean;
		buildMainLayout();
		setContent(mainLayout);
		this.setResizable(false);
		this.setCaption("ITEM RETURN REGISTER::  "+ sessionBean.getCompany());
