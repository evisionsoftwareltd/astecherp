...
public class RptReceiptRegister extends Window {
	...
	public  RptReceiptRegister(SessionBean sessionBean,String str) {
		this.sessionBean = sessionBean;
		buildMainLayout();
		setContent(mainLayout);
		this.setResizable(false);
		this.setCaption("ITEM RECEIPT REGISTER::  "+ sessionBean.getCompany());
...
/*			query= " select * from tbRawItemInfo a inner join tbRawItemCategory b "
			...
			/*query= " select a.Date ,a.ReceiptNo,a.ChallanNo,a.challanDate,a.poNo,d.poDate,b.ProductID,c.vRawItemName,c.vUnitName,b.Qty,b.Rate,e.supplierId, "
					"e.supplierName,c.vGroupName,c.vSubGroupName,c.vSubSubCategoryName,c.vCategoryType from  tbRawPurchaseInfo a "
					"inner join "
					...
					left join
					tbRawPurchaseOrderInfo d
					on d.poNo=a.poNo
					inner join
					tbSupplierInfo e
					on e.supplierId=a.SupplierId
					where CONVERT(Date,a.Date,105) between '' and '' and b.ProductID like ''*/
					...
					query= "select a.Date ,a.ReceiptNo,a.ChallanNo,a.challanDate,a.poNo,d.poDate,b.ProductID,c.vRawItemName,c.vUnitName,b.Qty,b.Rate,e.supplierId, "
							...
							+"tbSupplierInfo e "
							+"on e.supplierId=a.SupplierId "
							+"where CONVERT(Date,a.Date,105) between '"+new SimpleDateFormat("yyyy-MM-dd").format(pdffromdate.getValue())+" "+"23:59:59"+"' and '"+new SimpleDateFormat("yyyy-MM-dd").format(pdftodate.getValue())+"' and b.ProductID like '"+productID+"' and c.vCategoryType like '"+categirytype+"' and c.vGroupId like '"+categoryID+"' and c.vSubGroupId like '"+subcategoryID+"' and c.vsubsubCategoryId like '"+subsubcategory+"' "
							+"order by  CAST(SUBSTRING(c.vGroupId,2,LEN(c.vGroupId)) as int)   ,CAST(SUBSTRING(c.vSubGroupId,2,LEN(c.vSubGroupId)) as int) ,CAST(c.vsubsubCategoryId as int),c.vRawItemName " ;
		...
		/*	Window win = new ReportViewer(hm,"report/rawProductInfoRpt.jasper",
			...
			Window win = new ReportViewer(hm,"report/rptItemWisePurchaseRegister.jasper",
					this.getWindow().getApplication().getContext().getBaseDirectory()+"".replace("\\","/")+"/VAADIN/rpttmp",
					this.getWindow().getApplication().getURL()+"VAADIN/rpttmp",false,
