...
public class DpetWiseRqIssue extends Window 
{
	...
	private void ReqLoadData(){
		...
		String sql = "select distinct  IssueRef from  tbRawIssueInfo  where IssuedTo like '"+cmbProductionType.getValue().toString()+"' and IssueRef not like 'null' "
				+ "and IssueRef not like '' and  vflag='New' ";
	...
	private void DeptDataload(){
		...
		String sql= "select distinct  IssuedTo,(select SectionName from tbSectionInfo where AutoID=IssuedTo)sectionName "
				    +"from tbRawIssueInfo where IssueRef  not like 'null' and IssueRef not like '' and  vflag='New'";
	...
	{		
		...
		try
		{
			...
			query =  "select c.ReqNo ,a.Date , a.challanNo, b.ProductID,d.vRawItemName  ,ReqQty, ReqQty/25 Reqbag,Qty,Qty/25 bag,Rate,Rate*Qty  amount,d.vUnitName   from tbRawIssueInfo a inner join tbRawIssueDetails b "
					 ...
					 +"on d.vRawItemCode=b.ProductID where ReqNo='"+cmbReqNo.getValue().toString()+"' and  a.vflag='New' ";
