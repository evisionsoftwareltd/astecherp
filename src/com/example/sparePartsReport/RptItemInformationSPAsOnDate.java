...
public class RptItemInformationSPAsOnDate extends Window {
	...
	public  RptItemInformationSPAsOnDate(SessionBean sessionBean,String str) {
...
//		mainLayout.setHeight("270px");
		...
		parentType.setValue("Spare Parts");
...
//		mainLayout.addComponent(ogStockType, "top:170px; left:330px;");
		...
		mainLayout.addComponent( parentType, "top:38.0px;left:190.0px;");
	...
	private void productDataload()
	{
		...
		String query= " select vRawItemCode,vRawItemName  from tbRawItemInfo a inner join tbRawItemCategory b on a.vGroupId=b.Group_Id " +
				"where vGroupId like '"+strcategory+"' and vSubGroupId like '"+strsubcategory+"' and  " +
						"vsubsubCategoryId like '"+subsubcategory+"'  and a.vCategoryType like '"+categorytype+"' and a.vflag='New' order by vRawItemName";
