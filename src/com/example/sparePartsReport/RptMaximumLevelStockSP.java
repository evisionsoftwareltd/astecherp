...
public class RptMaximumLevelStockSP extends Window {
	...
	public  RptMaximumLevelStockSP(SessionBean sessionBean,String str) {
		this.sessionBean = sessionBean;
		buildMainLayout();
		setContent(mainLayout);
		this.setResizable(false);
		this.setCaption("MAXIMUM LEVEL STOCK STATEMENT ::  "+ sessionBean.getCompany());
...
/*
			...
			tx.commit();
             ...
             query="select * from   tbTmpLevelStatement where MaxLevel<=StockQty order by SUBSTRING(groupid,2,LEN(groupid)),SUBSTRING(subgroupid,2,LEN(subgroupid)),SUBSTRING(subsubgroupid,2,LEN(subsubgroupid))  ";     
		...
		/*	Window win = new ReportViewer(hm,"report/rawProductInfoRpt.jasper",
			...
			Window win = new ReportViewer(hm,"report/raw/rptmaxlevel.jasper",
					this.getWindow().getApplication().getContext().getBaseDirectory()+"".replace("\\","/")+"/VAADIN/rpttmp",
					this.getWindow().getApplication().getURL()+"VAADIN/rpttmp",false,
