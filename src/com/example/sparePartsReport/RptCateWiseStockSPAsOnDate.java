...
public class RptCateWiseStockSPAsOnDate extends Window {
	...
	int type=0;
	public RptCateWiseStockSPAsOnDate(SessionBean sessionBean,String str) {
		this.sessionBean = sessionBean;
		buildMainLayout();
		setContent(mainLayout);
		this.setResizable(false);
		//cmbDepartment.focus();
		this.setCaption("CATEGORY WISE STOCK AS ON DATE :: "+ sessionBean.getCompany());
...
//			query= "select * from dbo.funcStockSummary('"+CategoryId+"','"+SubCategoryId+"','"+new SimpleDateFormat("yyyy-MM-dd").format(AsonDate.getValue())+" 23:59:59"+"','"+cmbcategorytype.getValue().toString()+"') order by itemtype,categoryName,subCategoryName ";
			...
			{
			query = "select * from [dbo].[funCategoryWiseStockAsonDate] ('"+new SimpleDateFormat("yyyy-MM-dd").format(AsonDate.getValue())+" "+"23:59:59"+"','"+CategoryId+"','"+SubCategoryId+"','"+cmbcategorytype.getValue().toString()+"' ) where closingQty>0  order by catid,subcategoryid ";
		 ...
		 if (ogStockType.getValue().toString().equalsIgnoreCase("All"))
			{
			 query = "select * from [dbo].[funCategoryWiseStockAsonDate] ('"+new SimpleDateFormat("yyyy-MM-dd").format(AsonDate.getValue())+" "+"23:59:59"+"','"+CategoryId+"','"+SubCategoryId+"','"+cmbcategorytype.getValue().toString()+"' )  order by catid,subcategoryid ";
				System.out.println("query : "+query);
			}
				hm.put("sql", query);
			//System.out.println("query : "+query);
			...
			Window win = new ReportViewerNew(hm,"report/raw/rptRawCatWiseStockAsOn.jasper",
	...
	private AbsoluteLayout buildMainLayout() {
		...
		mainLayout.addComponent(ogStockType, "top:170.0px; left:130.0px");
		...
		mainLayout.addComponent(exitButton,"top:205.opx; left:260.0px");
