...
/*		cmbcategorytype.addListener(new ValueChangeListener()
		...
		chkAllsubsubCategory.addListener(new ValueChangeListener() {
			...
			{				
				  if(chkAllsubsubCategory.booleanValue())
				  {					
					  if ( (chkAllCategory.booleanValue() || cmbCategoryName.getValue()!=null ) && (chkAllsubsubCategory.booleanValue()|| cmbsubsubCategory.getValue()!=null)    )
					  {
...
/*
			...
			query= " select * from tbRawItemInfo a inner join tbRawItemCategory b "
					+" on a.vGroupId=b.Group_Id "
					+"where a.vCategoryType like '"+categirytype+"' and a.vGroupId like '"+categoryID+"' and "
					+ "a.vSubGroupId like '"+subcategoryID+"' and a.vsubsubCategoryId like '"+subsubcategory+"' "
							+ "and a.vRawItemCode like '"+productID+"' and a.vflag='New' "
									+ " order by  CAST(SUBSTRING(a.vGroupId,2,LEN(a.vGroupId)) as int)   ,CAST(SUBSTRING(a.vSubGroupId,2,LEN(a.vSubGroupId)) as int) ,CAST(a.vsubsubCategoryId as int)";
