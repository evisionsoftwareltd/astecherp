...
public class RptCateWiseStockDateBetween extends Window {
	...
	int type=0;
	public RptCateWiseStockDateBetween(SessionBean sessionBean,String str) 
	{
...
//			System.out.println(new SimpleDateFormat("yyyy-dd-MM").format(AsonDate.getValue())+" 23:59:59");
			hm.put("parentType", cmbcategorytyoe.getValue().toString());
...
//			query= "select * from dbo.funcStockSummary('"+CategoryId+"','"+SubCategoryId+"','"+new SimpleDateFormat("yyyy-MM-dd").format(AsonDate.getValue())+" 23:59:59"+"','"+cmbcategorytyoe.getValue().toString()+"') order by itemtype,categoryName,subCategoryName ";
			...
			{	
			query = "select * from [dbo].[funcatwiseStockDatebetween] ('"+new SimpleDateFormat("yyyy-MM-dd").format(pdffromdate.getValue())+"','"+new SimpleDateFormat("yyyy-MM-dd").format(pdftodate.getValue())+"', '%','"+CategoryId+"','"+SubCategoryId+"','"+cmbcategorytyoe.getValue().toString()+"' ) where closingQty>0  order by groupid,subgroupid ";
			...
			{
				query = "select * from [dbo].[funcatwiseStockDatebetween] ('"+new SimpleDateFormat("yyyy-MM-dd").format(pdffromdate.getValue())+"','"+new SimpleDateFormat("yyyy-MM-dd").format(pdftodate.getValue())+"', '%','"+CategoryId+"','"+SubCategoryId+"','"+cmbcategorytyoe.getValue().toString()+"' ) order by groupid,subgroupid ";
				System.out.println("query : "+query);
