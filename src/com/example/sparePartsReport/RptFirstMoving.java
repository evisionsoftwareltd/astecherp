...
public class RptFirstMoving extends Window {
	...
	public RptFirstMoving(String str,SessionBean sessionBean) 
	{
		this.sessionBean = sessionBean;
		buildMainLayout();
		setContent(mainLayout);
		this.setResizable(false);
		this.setCaption("First Moving Item Information::  "+ sessionBean.getCompany());
	...
	private void reportShow()
	{
		...
		try{
			...
			session.createSQLQuery("exec PrcfirstMoving '"+new SimpleDateFormat("yyyy/MM/dd").format(dAsOnDate.getValue()) +" "+"23:59:59" + "','"+categoryID+"'  ,'"+productID+"','"+categoryType+"'   ").executeUpdate();
			tx.commit();
			...
			Window win = new ReportViewerNew(hm,"report/raw/rptFirstMoving.jasper",
