...
public class COGPBetweenDate extends Window{
	...
	public COGPBetweenDate(SessionBean sessionBean){
	...
	private void masterproductDataLoad()
	{
		...
		try
		{
			...
			String sql="select distinct b.fgId,b.fgName from tbMouldFinishProduct a "+
			 "inner join tbFinishedProductDetailsNew b on a.productId=b.semiFgId order by b.fgName ";
	...
	{	
		...
		try{
			...
			hm.put("masterProduct",cmbMasterProduct.getItemCaption(cmbMasterProduct.getValue()) );
