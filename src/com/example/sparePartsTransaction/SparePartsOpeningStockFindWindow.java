...
public class SparePartsOpeningStockFindWindow extends Window
{
	...
	public SparePartsOpeningStockFindWindow(SessionBean sessionBean,TextField txtReceiptProductId,TextField txtReceiptOpeningYear)
	{
	...
	public void categoryTypeDataLoad()
	{
		...
		try
		{
			...
			List list=session.createSQLQuery("select distinct 0,vCategoryType from tbRawItemCategory where vCategoryType  like '%Spare Parts%' ").list();
