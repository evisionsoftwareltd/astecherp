...
public class SparePartsLoanIssueRcvRtn extends Window {
	...
	public SparePartsLoanIssueRcvRtn(SessionBean sessionBean)
	{
	...
	public void tableRowAdd(final int ar)
	{
		...
		try
		{
			...
			List lst1 = dbService("select distinct 0,vCategoryType from tbRawItemInfo where vCategoryType  like '%Spare Parts%'");
