...
public class ConvertionCostHeadFind extends Window
{
	...
	public ConvertionCostHeadFind(SessionBean sessionBean,TextField txtReceiptSupplierId)
	{
		this.txtReceiptSupplierId = txtReceiptSupplierId;
		this.sessionBean=sessionBean;
		this.setCaption("CONVERSION COST HEAD FIND :: "+this.sessionBean.getCompany());
		this.center();
		this.setWidth("470px");
		this.setHeight("270");
	...
	private void tableDataAdding()
	{
		try
		{
			...
			String query ="Select headId,headName FROM tbConversionCostHeadInfo";
