...
public class RawItemCategory extends Window 
{
	...
	public RawItemCategory(SessionBean sessionBean) 
	{
		...
		this.setCaption("ITEM CATEGORY :: " + sessionBean.getCompany());
	...
	{
		Window win = new RawItemCategoryFind(sessionBean, txtCategoryID);
	...
	private void findInitialise(String txtCategoryId) 
	{
		...
		try 
		{
			...
			List led = session.createSQLQuery("Select iCategoryCode,vCategoryName,Group_Id,vCategoryType from tbRawItemCategory Where iCategoryCode = '"+txtCategoryId+"'").list();
	...
	private void insertData()
	{
		...
		try
		{
			...
			String insertQuery = "Insert Into tbRawItemCategory (iCategoryCode,vCategoryName,Group_Id,vUserName,vUserIP,dtEntryTime,vCategoryType,vflag)" +
					...
					" '"+sessionBean.getUserName()+"','"+sessionBean.getUserIp()+"',CURRENT_TIMESTAMP,'"+type.getValue()+"','OLD')";
	...
	public void updateData() 
	{
		...
		try
		{
			...
			String updateQuery = "Update tbRawItemCategory set " +
					...
					" dtEntryTime= CURRENT_TIMESTAMP, vCategoryType = '"+strcattype+"' ,vflag='OLD'  where iCategoryCode = '"+categoryRead.getValue()+"'";
