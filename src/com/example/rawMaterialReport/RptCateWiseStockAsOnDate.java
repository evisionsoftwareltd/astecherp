...
public class RptCateWiseStockAsOnDate extends Window {
	...
	int type=0;
	public RptCateWiseStockAsOnDate(SessionBean sessionBean,String str) {
...
//			query= "select * from dbo.funcStockSummary('"+CategoryId+"','"+SubCategoryId+"','"+new SimpleDateFormat("yyyy-MM-dd").format(AsonDate.getValue())+" 23:59:59"+"','"+cmbcategorytyoe.getValue().toString()+"') order by itemtype,categoryName,subCategoryName ";
			...
			{
			query = "select * from [dbo].[funCategoryWiseStockAsonDate] ('"+new SimpleDateFormat("yyyy-MM-dd").format(AsonDate.getValue())+" "+"23:59:59"+"','"+CategoryId+"','"+SubCategoryId+"','"+cmbcategorytyoe.getValue().toString()+"' ) where closingQty>0  order by catid,subcategoryid ";
		 ...
		 if (ogStockType.getValue().toString().equalsIgnoreCase("All"))
			{
			 query = "select * from [dbo].[funCategoryWiseStockAsonDate] ('"+new SimpleDateFormat("yyyy-MM-dd").format(AsonDate.getValue())+" "+"23:59:59"+"','"+CategoryId+"','"+SubCategoryId+"','"+cmbcategorytyoe.getValue().toString()+"' )  order by catid,subcategoryid ";
				System.out.println("query : "+query);
			}
				hm.put("sql", query);
			//System.out.println("query : "+query);
