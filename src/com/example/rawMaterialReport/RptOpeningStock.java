...
public class RptOpeningStock extends Window 
{
	...
	//boolean type=true;
	int type=1;
	public  RptOpeningStock(SessionBean sessionBean,String str) {
	...
	private void productDataload()
	{
		...
		String query= " select vRawItemCode,vRawItemName  from tbRawItemInfo a inner join tbRawItemCategory b on a.vGroupId= b.Group_Id where vGroupId like  '"+strcategory+"'  and vSubGroupId like  '"+strsubcategory+"'  "
				+ "and  vsubsubCategoryId like  '"+subsubcategory+"'  and a.vCategoryType like '"+categorytype+"'   ";
...
/*
			...
			*/		
			...
			query= " select * from tbRawProductOpening a "
					...
					+ "and b.vGroupId like '"+categoryID+"' and b.vSubGroupId like '"+subcategoryID+"' and "
			...
			query= " select * from tbRawProductOpening a "
					...
					+ "and b.vsubsubCategoryId like '"+subsubcategory+"' and  DATEPART(YEAR,a.openingYear) like '"+dateFormat.format(dOpeningYear.getValue())+"' and a.qty=0 "
					+ " order by cast(substring(b.vGroupId,2,LEN(b.vGroupId)) as int),cast(substring(b.vsubsubCategoryId,2,LEN(b.vsubsubCategoryId)) as int), b.vGroupId ,b.vSubGroupId " ;			
			}
			...
			query= " select * from tbRawProductOpening a "
					...
					+"on a.productId=b.vRawItemCode "
					+"where  b.vCategoryType like '"+cmbcategorytype.getValue()+"' and b.vRawItemCode like '"+productID+"'  and b.vGroupId like '"+categoryID+"' and b.vSubGroupId like '"+subcategoryID+"' "
					+ "and b.vsubsubCategoryId like '"+subsubcategory+"' and  DATEPART(YEAR,a.openingYear) like '"+dateFormat.format(dOpeningYear.getValue())+"'  "
					+ " order by cast(substring(b.vGroupId,2,LEN(b.vGroupId)) as int),cast(substring(b.vsubsubCategoryId,2,LEN(b.vsubsubCategoryId)) as int), b.vGroupId ,b.vSubGroupId " ;			
			}
