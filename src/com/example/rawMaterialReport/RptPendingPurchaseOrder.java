...
public class RptPendingPurchaseOrder extends Window {
	...
	public RptPendingPurchaseOrder(SessionBean sessionBean,String str) {
		this.sessionBean = sessionBean;
		buildMainLayout();
		setContent(mainLayout);
		this.setResizable(false);
		this.setCaption("PENDING PURCHASE ORDER ::  "+ sessionBean.getCompany());
	...
	private void reportShow()
	{
		...
		try{
			...
			{
				Window win = new ReportViewerNew(hm,"report/raw/rptPendingPurchaseOrder.jasper",
