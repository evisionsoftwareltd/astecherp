...
public class RptDeptWiseIssueNew extends Window {
	...
	public void addSectionName(String category)
	{
		...
		try{
			...
			String query=  
					 "select distinct  a.IssuedTo,(select SectionName from tbSectionInfo where CAST(AutoID as varchar)=a.IssuedTo) SectionName,(select vDepartmentName from tbSectionInfo where AutoID=a.IssuedTo)deptName from tbRawIssueInfo a "
					 +"inner join " 
					 +"tbRawIssueDetails b  "
					 +" on a.IssueNo=b.IssueNo " 
					 +"inner join " 
					 ...
					 +"is null "
					 +"union all "
					 +"select distinct  a.IssuedTo,d.supplierName,ISNULL((select vDepartmentName from tbSectionInfo where AutoID=a.IssuedTo),'') deptName  from tbRawIssueInfo a " 
					 +"inner join " 
					 +"tbRawIssueDetails b "
					 +"on a.IssueNo=b.IssueNo "
					 +"inner join " 
