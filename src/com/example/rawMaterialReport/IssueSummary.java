...
public class IssueSummary extends Window {
	...
	public  IssueSummary(SessionBean sessionBean,String str) {
		...
		Component ob[]={cmbcategorytype,cmbCategoryName,cmbsubcategoryName,cmbproductName,pdffromdate,pdftodate,previewButton};
