...
public class RptLoanIssueReturn extends Window {
	...
	public RptLoanIssueReturn(SessionBean sessionBean,String str) {
		this.sessionBean = sessionBean;
		buildMainLayout();
		setContent(mainLayout);
		this.setResizable(false);
		this.setCaption("Loan Issue/Return Statement ::  "+ sessionBean.getCompany());
	...
	private AbsoluteLayout buildMainLayout() 
	{
		...
		cmbsupplierName.setWidth("320px");
		...
		mainLayout.addComponent(chkAllSupplier, "top:38.0px;left:465.0px;");
		...
		mainLayout.addComponent(chkAllName, "top:64.0px;left:465.0px;");
		...
		lblline.setValue("_______________________________________________________________________________________________________");
	...
	private void supplierdata()
	{
		...
		String query = "select supplierId,supplierName from tbSupplierInfo where supplierId in (select IssuedTo from tbRawIssueInfo where IssueType like '%Loan Issue%' )";
	...
	private void productData()
	{
		...
		String query = "select vRawItemCode,vRawItemName from tbRawItemInfo where vRawItemCode in "
				       +"(  select distinct ProductID from tbRawIssueDetails    where IssueNo in (select IssueNo from tbRawIssueInfo "
				       + " where IssueType  like '%Loan Issue%' and IssuedTo  like  '"+supplier+"'))";
	...
	private void reportShow()
	{
		...
		try{
            ...
            //Select distinct poNo,poDate,quotaRef,quotaDate,supplierId,SupplierName,(select SUM(amount) from vwPurchaseOrderRegister) as total,(select COUNT(productId) from vwPurchaseOrderRegister) as totalProduct from vwPurchaseOrderRegister where supplierId like '3' and poDate between '2014-02-02' and '2014-03-03'
			//query="Select * from vwPurchaseOrderRegister where supplierId = '"+cmbSupplierName.getValue()+"' and poDate between '"+FromDate+"' and '"+ToDate+"'";
			query="select * from [funLoanIssueReturnNew]('"+FromDate+"','"+ToDate+"', '"+productID +"',  '"+supplierID+"')";
			
			System.out.println(query);
			hm.put("sql", query);


			Window win = new ReportViewerNew(hm,"report/raw/rptLoanIssueReturn.jasper",
