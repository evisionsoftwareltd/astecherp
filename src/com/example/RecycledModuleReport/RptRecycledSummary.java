...
public class RptRecycledSummary extends Window {
	...
	boolean type=false;
	public RptRecycledSummary(SessionBean sessionBean,String str) {
		this.sessionBean = sessionBean;
		setContent(buildMainLayout());
		this.setResizable(false);
		this.setCaption("RECYCLE SUMMARY ::  "+ sessionBean.getCompany());
		cmbSectionName.focus();
		Component ob[]={AsOnDate, cmbSectionName,  previewButton};
	...
	private void reportShow()
	{
		...
		try{
			...
			hm.put("sectionName", cmbSectionName.getItemCaption(cmbSectionName.getValue()));


			query= "select * from funRejectionRecycledSummarySectionWise("
			...
			if(!lst.isEmpty())
			{
				Window win = new ReportViewer(hm,"report/production/RecycledModuleReport/RptRejectedRecycledSummary.jasper",
	...
	private AbsoluteLayout buildMainLayout() {
		...
		mainLayout.addComponent(lblAsOnDate, "top:68.0px;left:25.0px;");
		...
		mainLayout.addComponent(AsOnDate, "top:66.0px;left:110.0px;");
