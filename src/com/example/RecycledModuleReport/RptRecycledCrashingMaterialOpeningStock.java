...
public class RptRecycledCrashingMaterialOpeningStock extends Window {
	...
	public RptRecycledCrashingMaterialOpeningStock(SessionBean sessionBean,String str) {
		this.sessionBean = sessionBean;
		setContent(buildMainLayout());
		this.setResizable(false);
		this.setCaption("CRASHING MATERIAL OPENING STOCK ::  "+ sessionBean.getCompany());
	...
	public void addProductName()
	{
		...
		try{
			...
			String query = "select vItemId,vItemName from tbRecycleItemOpening";
	...
	private void reportShow()
	{
		...
		try{
			...
			hm.put("section", cmbProductName.getItemCaption(cmbProductName.getValue()));
				...
				query= "select vBaseProductId,vBaseProductName,vItemId,vItemName,vUnit,vGrade,vColor,iQty,(select SectionName from tbSectionInfo where section=tbsectioninfo.AutoID)sectionName,"
						+ "vCategoryName,vSubCategoryName from tbRecycleItemOpening  "
						+ "where YEAR(dTransactionDate)='"+new SimpleDateFormat("yyyy").format(OpeningYear.getValue())+"' "
						+ "and vItemId like '"+ProductionName+"' "
						+ "order by vBaseProductId";
			...
			if(!lst.isEmpty())
			{
				Window win = new ReportViewer(hm,"report/production/RecycledModuleReport/RptRecycledCrashingMaterialOpeningStock.jasper",
