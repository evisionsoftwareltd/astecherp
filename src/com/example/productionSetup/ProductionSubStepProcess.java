...
public class ProductionSubStepProcess extends Window 
{
	@AutoGenerated
	...
	@AutoGenerated
	private NativeButton nbGroup,nbGroupStep;
	...
	public ProductionSubStepProcess(SessionBean sessionBean) 
	{
		buildMainLayout();
		this.sessionBean=sessionBean;
		this.setCaption("PRODUCTION PROCESS SUB STEP :: " + sessionBean.getCompany());
		...
		cmbGroupName.addListener(new ValueChangeListener() {
			...
			public void valueChange(ValueChangeEvent event) {
				...
				if(cmbGroupName.getValue()!=null){
					...
					trSubGroupId.setValue(token.nextToken()+"SUBSTP-"+subGroupIdWork());
	...
	private String subGroupIdWork(){
		...
		try 
		{
			...
			String sql="select isnull(max(cast(SUBSTRING(Substepid,CHARINDEX('-',SubstepId)+1,len(SubstepId)-CHARINDEX('-',SubstepId)) as int)),0)+1 as cat from tbProductionSubStep where productionTypeId like   '"+cmbGroupName.getValue()+"' and productionStepId='"+cmbStep.getValue()+"'";
	...
	{
		Window win = new ProductionSubStepFindWindow(sessionBean, txtSubGroupID);
	...
	private void findInitialise(String txtSubGroupId) 
	{
		...
		try 
		{
			...
			List led = session.createSQLQuery("select SubStepId,SubStepName,ProductionTypeId,ProductionStepId from tbProductionSubStep Where subStepId = '"+txtSubGroupId+"'").list();
	...
	public void updateData() 
	{
		...
		try
		{
			...
			String updateQuery = "Update tbProductionSubStep set SubstepName = '"+txtSubGroupName.getValue().toString().trim()+"', ProductionTypeId='"+cmbGroupName.getValue()+"',ProductionStepId='"+cmbStep.getValue()+"',UserName ='"+sessionBean.getUserName()+"', UserIP='"+sessionBean.getUserIp()+"', EntryTime= CURRENT_TIMESTAMP where SubstepId = '"+trSubGroupId.getValue().toString().trim()+"'";
	...
	private void insertData()
	{
		...
		try
		{
			...
			String insertQuery = "Insert Into tbProductionSubStep (SubStepId,SubStepName,productionTypeId,productionStepId,UserName,UserIP,EntryTime) values ('"+trSubGroupId.getValue().toString().trim()+"','"+txtSubGroupName.getValue().toString().trim()+"','"+cmbGroupName.getValue()+"','"+cmbStep.getValue()+"','"+sessionBean.getUserName()+"','"+sessionBean.getUserIp()+"',CURRENT_TIMESTAMP)";
	...
	private AbsoluteLayout buildMainLayout() 
	{
		...
		// lblSubGRoupID
		lblSubGRoupID = new Label("Production Sub Step Id :");
		...
		trSubGroupId.setWidth("121px");
		trSubGroupId.setHeight("24px");
		mainLayout.addComponent(trSubGroupId, "top:34.0px;left:180.0px;");

		// lblSubGroupName
		lblSubGroupName = new Label("Production Sub Step Name :");
		...
		mainLayout.addComponent(txtSubGroupName, "top:63.0px;left:180.0px;");
		//lblGrouopName
		...
		mainLayout.addComponent(cmbGroupName, "top:92.0px;left:180.0px;");
		...
		mainLayout.addComponent(nbGroup,"top:92.0px;left:465.0px;");
		...
		mainLayout.addComponent(cmbStep, "top:121.0px;left:180.0px;");
		...
		mainLayout.addComponent(nbGroupStep,"top:121.0px;left:465.0px;");
		...
		mainLayout.addComponent(button, "top:185.0px;left:12.0px;");
