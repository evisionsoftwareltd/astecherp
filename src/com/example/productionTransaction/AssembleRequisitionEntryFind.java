...
public class AssembleRequisitionEntryFind extends Window {
	...
	public AssembleRequisitionEntryFind(SessionBean sessionBean,TextField BatchNo)
	{
		this.txtReceiptAreaId = BatchNo;
		this.sessionBean=sessionBean;
		this.setCaption("REQUISITION(ASSEMBLE) FIND :: "+sessionBean.getCompany());
		this.center();
		this.setWidth("550px");
	...
	private void findButtonEvent() {
		...
		Iterator iter=dbService("select ReqFrom,batchNo,ReqNo,convert(varchar(10),reqDate,103) " +
				"from tbRequisitionEntryAssembleInfo where reqDate between " +
		...
		if(iter.hasNext()){
			...
			showNotification("Sorry!!","There ar no data",Notification.TYPE_WARNING_MESSAGE);
		}
	}
	private void tableclear()
	{
