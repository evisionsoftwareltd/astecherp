...
public class IssueToLabelingPrintingFind extends Window
{
	...
	public IssueToLabelingPrintingFind(SessionBean sessionBean,TextField txtIssueNo)
	{
		this.txtIssueNo=txtIssueNo;
		this.sessionBean=sessionBean;
		this.setResizable(false);
		this.setCaption("ISSUE TO LABEL/PRINTING FIND :: "+sessionBean.getCompany());
	...
	private void IssueToLoad() {
		...
		Iterator iter=dbService("select 0,issueTo from tbIssueToLabelPrintingInfo where issueDate "+
	...
	private void tableDataLoad() {
		...
		Iterator iter=dbService("select issueNo,issueTo,ReqNo,batchNo,convert(varchar(103),issueDate,103)issueDate from tbIssueToLabelPrintingInfo "+ 
