...
public class RequisitionLabelingPrintingFindWindow extends Window {
		...
		public RequisitionLabelingPrintingFindWindow(SessionBean sessionBean,TextField BatchNo)
		{
			this.txtReceiptAreaId = BatchNo;
			this.sessionBean=sessionBean;
			this.setCaption("REQUISITION(LABELING/PRINTING) FIND :: "+sessionBean.getCompany());
			this.center();
			this.setWidth("550px");
		...
		private void findButtonEvent() {
			...
			Iterator iter=dbService("select ReqFrom,batchNo,ReqNo,convert(varchar(10),reqDate,103) " +
					"from tbRequisitionEntryLabelingPrintingInfo where reqDate between " +
					"'"+dateFormat.format(dFromDate.getValue())+"' and '"+dateFormat.format(dToDate.getValue())+"'" +
					"and ReqFrom !='Assemble' order by reqDate,ReqFrom");
			if(iter.hasNext()){
				while(iter.hasNext()){
