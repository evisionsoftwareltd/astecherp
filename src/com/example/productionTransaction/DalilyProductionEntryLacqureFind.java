...
public class DalilyProductionEntryLacqureFind extends Window
{
	...
	public DalilyProductionEntryLacqureFind(SessionBean sessionBean,TextField txtProductionNo)
	{
		this.txtProductionNo=txtProductionNo;
		this.sessionBean=sessionBean;
		this.setResizable(false);
		this.setCaption("DAILY PRODUCTION ENTRY [LACQURE] FIND :: "+sessionBean.getCompany());
	...
	private void tableDataLoad() {
		...
		Iterator iter=dbService("select productionStep,productionNo,convert(varchar(10),productionDate,103) from tbLacqureDailyProductionInfo  " +
