...
public class IssueToLacqureFind extends Window
{
	...
	public IssueToLacqureFind(SessionBean sessionBean,TextField txtIssueNo)
	{
		this.txtIssueNo=txtIssueNo;
		this.sessionBean=sessionBean;
		this.setResizable(false);
		this.setCaption("ISSUE TO LACQURE FIND :: "+sessionBean.getCompany());
	...
	private void IssueToLoad() {
		...
		Iterator iter=dbService("select 0,issueTo from tbIssueToLacqureInfo where issueDate "+
	...
	private void tableDataLoad() {
		...
		Iterator iter=dbService("select issueNo,issueTo,ReqNo,batchNo,convert(varchar(103),issueDate,103)issueDate from tbIssueToLacqureInfo "+ 
